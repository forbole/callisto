...
func NewShieldPool(
	poolID uint64, shield sdk.Int, serviceFees sdk.Coins, sponsor string,
...
func NewShieldProvider(address string, collateral int64, delegationBonded int64,
	rewards sdk.DecCoins, totalLocked int64,
...
type ShieldStatus struct {
	...
	CurrentServiceFees   sdk.DecCoins
...
func NewShieldStatus(gobalStakingPool sdk.Int, currentServiceFees sdk.DecCoins,
	remainingServiceFees sdk.DecCoins, totalCollateral sdk.Int, totalShield sdk.Int,
