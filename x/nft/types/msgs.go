...
func NewMsgEditNFT(
	tokenID, denomID, tokenName, tokenDescription, tokenURI string, tokenTags []string, sender string,
) *MsgEditNFT {
	return &MsgEditNFT{
		Id:          tokenID,
		DenomId:     denomID,
...
func NewMsgMintNFT(
	tokenID, denomID, tokenName, tokenDescription, tokenURI string, tokenTags []string, sender, recipient string,
) *MsgMintNFT {
	return &MsgMintNFT{
		Id:          tokenID,
		DenomId:     denomID,
