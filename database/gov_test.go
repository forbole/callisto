...
func (suite *DbTestSuite) TestBigDipperDb_SaveGovParams() {
	...
	original := types.NewGovParams(types.NewvotingParams(votingParams),types.NewdepositParam(depositParams), tallyParams,10)
	...
	updated := types.NewGovParams(types.NewvotingParams(votingParams),types.NewdepositParam(depositParams), tallyParams,9)
	...
	updated = types.NewGovParams(types.NewvotingParams(votingParams),types.NewdepositParam(depositParams), tallyParams,10)
	...
	updated = types.NewGovParams(types.NewvotingParams(votingParams),types.NewdepositParam(depositParams), tallyParams,11)
