...
func (db *BigDipperDb) pruneBank(height int64) error {
...
func (db *BigDipperDb) pruneStaking(height int64) error {
...
func (db *BigDipperDb) pruneMint(height int64) error {
	_, err := db.Sql.Exec(`DELETE FROM inflation WHERE height = $1`, height)
	return err
}

func (db *BigDipperDb) pruneDistribution(height int64) error {
...
func (db *BigDipperDb) pruneSlashing(height int64) error {
