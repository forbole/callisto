import (
	...
	"fmt"
	"strings"
	authtype "github.com/cosmos/cosmos-sdk/x/auth/vesting/types/period"
...
func NewPeriod(period authtype.Period) Period {
...
func (period Period) Equal(d Period) bool {
...
func (coin *Periods) Scan(src interface{}) error {
...
func NewPeriods(coins sdk.Period) DbCoins {
