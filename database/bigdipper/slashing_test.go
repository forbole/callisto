...
func (suite *DbTestSuite) TestBigDipperDb_ValidatorSigningInfo() {
	...
	// Save the data
	infos := []bslashingtypes.ValidatorSigningInfo{
		bslashingtypes.NewValidatorSigningInfo(
...
func (suite *DbTestSuite) TestBigDipperDb_SaveSlashingParams() {
	// Save data
	params := bslashingtypes.NewParams(
	...
	err = suite.database.SaveSlashingParams(bslashingtypes.NewParams(
		slashingtypes.Params{
