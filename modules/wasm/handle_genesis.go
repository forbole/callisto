...
func (m *Module) HandleGenesis(doc *cometbfttypes.GenesisDoc, appState map[string]json.RawMessage) error {
...
func (m *Module) SaveGenesisContracts(contracts []wasmtypes.Contract, doc *cometbfttypes.GenesisDoc) error {
