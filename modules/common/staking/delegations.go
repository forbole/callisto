...
func UpdateValidatorsDelegations(
	height int64, validators []stakingtypes.Validator, client stakingtypes.QueryClient, db *bigdipperdb.Db,
) {
...
func UpdateDelegations(height int64, delegator string, client stakingtypes.QueryClient, db DB) error {
	// Get the delegations
