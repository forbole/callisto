...
// 	app := coreumapp.New(log.NewTMLogger(log.NewSyncWriter(os.Stdout)), source.StoreDB, nil, true, map[int64]bool{},
// 		cfg.Home, 0, config.EncodingConfig{}, simapp.EmptyAppOptions{}, nil, nil,
// 	)
