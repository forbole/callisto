...
func BuildSources(nodeCfg nodeconfig.Config, encodingConfig *params.EncodingConfig) (*Sources, error) {
	...
	case *local.Details:
		return nil, fmt.Errorf("local source is currently not supported")
...
// 		cfg.Home, 0, quasarappparams.EncodingConfig{}, simapp.EmptyAppOptions{}, []wasmtypes.ProposalType{}, []wasmkeeper.Option{}, nil,
// 	)
