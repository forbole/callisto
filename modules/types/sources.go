...
func BuildSources(nodeCfg nodeconfig.Config, encodingConfig *params.EncodingConfig) (*Sources, error) {
	...
	case *local.Details:
		return nil, fmt.Errorf("local node mode is currently not supported: %T", cfg)
...
// 	// app := stargazeapp.NewStargazeApp(log.NewTMLogger(log.NewSyncWriter(os.Stdout)), source.StoreDB, nil, true, map[int64]bool{},
// 	// 	cfg.Home, 0, cosmoscmd.EncodingConfig{}, nil, []wasm.Option{}, []wasmtypes.ProposalType{}, nil,
// 	// )
