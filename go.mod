...
require (
	...
	github.com/comdex-official/comdex v0.1.1-0.20220920172704-763a6c6e072d
...
replace (
	github.com/cosmos/gaia/v7 => github.com/MonMonCat/gaia/v7 v7.0.4-0.20221012120900-fa6da0c011b2
