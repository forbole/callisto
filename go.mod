...
require (
	...
	github.com/persistenceOne/persistenceCore/v7 v7.0.0-rc0
...
require (
	...
	github.com/persistenceOne/persistence-sdk/v2 v2.0.0-rc0 // indirect
	github.com/persistenceOne/pstake-native/v2 v2.0.0-rc0 // indirect
