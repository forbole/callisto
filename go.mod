...
require (
	...
	github.com/MonCatCat/provenance v1.3.2-0.20240103095109-0cf07b0b3a03 // branch bdjuno-v1.17.0
	github.com/cometbft/cometbft v0.38.2
	github.com/cosmos/cosmos-sdk v0.46.13
	github.com/forbole/juno/v5 v5.0.0-20240102103911-6ff1d9ec9a0f
